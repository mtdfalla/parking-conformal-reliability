...
summ.to_csv(TAB/"2026-09-04-vignette-repro-control.csv")
res.to_csv(TAB/"2026-09-04-vignette-repro-control-requests.csv", index=False)
...
fig.tight_layout(); fig.savefig(FIG/"repro-gate-diagnostic.png", dpi=200)
print("figure saved")
